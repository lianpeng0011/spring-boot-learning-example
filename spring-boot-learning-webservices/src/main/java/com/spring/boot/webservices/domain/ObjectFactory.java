 ...
 * generated in the com.spring.boot.webservices.domain package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.spring.boot.webservices.domain
     * 
     */
